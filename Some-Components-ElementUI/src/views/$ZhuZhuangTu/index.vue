<template>
    <div class="comprehensive-rank">
        <div class="header">
            <el-form :inline="true" :model="formConfig" class="demo-form-inline" size="small">
                ...
                <el-form-item>
                    ...
                    <el-button type="success">导出晾晒报表</el-button>
                </el-form-item>
            </el-form>
...
<script>
import { sortByColumns } from '@/utils/index.js'
const orignList = [
    [50, 60, 40, 70, 90, 120, 30, 40, 75, 50, 60, 70, 30, 45, 65, 90, 100, 55, 22, 66, 77],
    [50, 60, 40, 70, 90, 120, 30, 40, 75, 50, 60, 70, 30, 45, 65, 90, 100, 55, 22, 66, 77],
    [50, 60, 40, 70, 90, 120, 30, 40, 75, 50, 60, 70, 30, 45, 65, 90, 100, 55, 22, 66, 77],
    [50, 60, 40, 70, 90, 120, 30, 40, 75, 50, 60, 70, 30, 45, 65, 90, 100, 55, 22, 66, 77],
    [50, 60, 40, 70, 90, 120, 30, 40, 75, 50, 60, 70, 30, 45, 65, 90, 100, 55, 22, 66, 77],
...
export default {
    data() {
        return {
            series,
            reachCondition: [{ name: '专项前10名', checked: true }, { name: '专项前五名', checked: true }],
            formConfig: {
                mode: 'all',
                region: 'all',
                city: 'all',
    ...
    watch: {
        series: {
            ...
            handler: function (val) {
                const op = Object.assign(option, { series: val.filter(item => item.checked) })
                chart.setOption(op, true)
            }
        }
    },
